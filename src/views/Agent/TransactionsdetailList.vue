            ...
            <div class="mui-inner-wrap">
                    ...
                    <div class="mui-scroll-wrapper">
                        <div class="mui-scroll">
                            ...
                            <section class="el-container is-vertical">
                                <Divider class="top-title">{{
                                    $t('agent.transactionsdetailList.transactionsdetailList1')}}
                                </Divider><!--用户名 -->
                                <input
                                        type="search"
                                ...
                                <div class="el-row text-center">
                                    ...
                                    >
                                        <span>{{ $t('agent.transactionsdetailList.transactionsdetailList3')}}</span>
                                        <!--查询-->
                                    </button>
                                </div>
                            </section>
                ...
                <div class="header">
                    ...
                    <div class="header-middle">
                        {{ $t('agent.transactionsdetailList.transactionsdetailList4')}}
                    </div>
                    <div class="header-right" @tap="mShowSearch('open')">
                        {{ $t('agent.transactionsdetailList.transactionsdetailList5')}}
                    </div>
                </div>
                                ...
                                <div class="rowbg el-row">
                                    ...
                                    <div class="info">
                                        <div>
                                            ...
                                            <div class="Types">
                                                {{ $t('agent.transactionsdetailList.transactionsdetailList7')}}<!-- 钱包类型-->
                                            </div>
                                        </div>
                                        <div>
                                            <div class="status">{{item.beforeAmount/100}}</div>
                                            <div class="Types">
                                                {{$t('agent.transactionsdetailList.transactionsdetailList8')}}<!-- 操作前资金-->
                                            </div>
                                        </div>
                                        <div>
                                            <div class="status">{{item.amount/100}}</div>
                                            <div class="Types">
                                                {{$t('agent.transactionsdetailList.transactionsdetailList9')}}<!-- 操作资金-->
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="info">
                                        <div style="width: 40%;">
                                            ...
                                            <div class="Types">
                                                {{ $t('agent.transactionsdetailList.transactionsdetailList10')}}<!--操作后资金 -->
                                            </div>
                                        </div>
            ...
            mReachBottom() {
                return new Promise(resolve => {
                    ...
                    if (
                        ...
                        this.mLoading(false);
                        //没有更多记录了
                        this.$Message.warning(_this.$t('agent.transactionsdetailList.transactionsdetailList12'));
                        resolve();
                    }
                });
            },
