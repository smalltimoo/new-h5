        ...
        <div class="container">
            <div v-for="(item, index) in activities" :key="index" style="margin-top: 7px">
                ...
                <div class="dis-panel" @click="showDrawer(item)">
                    ...
                    <img :src="item.activityImg" style="width: 100%; border-radius: 5px">
                    <div class="tip" v-text="item.giveTypeStr"
                         style="text-align: left;border-bottom:solid 1px #f3f3f3;padding-bottom: 4px"></div>
                    <div class="go">
                        <span>查看详情</span>
