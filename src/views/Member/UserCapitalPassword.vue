  ...
  <div id="app">
    <div class="publicpage">
      <div class="userCapitalPwd G_Form publicpage_view">
        ...
        <div class="row Carpittitle">{{ $t('member.userCapitalPassword.ucp2') }}</div><!-- 为了您账户安全，真实姓名需要与绑定银行卡姓名一致-->
        <form class="el-form el-form--label-right">
          <div class="el-form-item">
            <label class="el-form-item__label" style="width: 90px;">{{ $t('member.userCapitalPassword.ucp3') }}</label><!--真实姓名 -->
          ...
          <div class="el-form-item">
            <label class="el-form-item__label" style="width: 90px;">{{ $t('member.userCapitalPassword.ucp5') }}</label><!--银行卡号 -->
            <div class="el-form-item__content" style="margin-left: 90px;">
              <div class="el-input">
                <input
                  v-model="vm.account"
          ...
          <div class="line-w"></div>
          <div class="el-form-item">
            <label class="el-form-item__label" style="width: 90px;">{{ $t('member.userCapitalPassword.ucp7') }}</label><!--省市县(区) -->
            <div class="el-form-item__content" style="margin-left: 90px;">
              <div class="el-input">
                <input
                  @tap="mShowpcaPicker"
          ...
          <div class="line-w"></div>
          <div class="el-form-item">
            <label class="el-form-item__label" style="width: 90px;">{{ $t('member.userCapitalPassword.ucp9') }}</label><!--银行种类 -->
            <div class="el-form-item__content" style="margin-left: 90px;">
              <div class="el-input">
                <input
                  @tap="mShowBankPicker"
          ...
          <div class="line-w"></div>
          <div class="el-form-item">
            <label class="el-form-item__label" style="width: 90px;">{{ $t('member.userCapitalPassword.ucp11') }}</label><!-- 开户行名称-->
            <div class="el-form-item__content" style="margin-left: 90px;">
              <div class="el-input">
                <input
                  onchange="listen"
          ...
          <div class="line-w"></div>
          <div class="el-form-item">
            <label class="el-form-item__label" style="width: 90px;">{{ $t('member.userCapitalPassword.ucp13') }}</label><!--手机号 -->
            <div class="el-form-item__content" style="margin-left: 90px;">
              <div class="el-input">
                <input
                  v-model="vm.mobile"
        ...
        <div class="el-row">
          <div class="el-col el-col-24">
            <div class="Text">{{$t('member.userCapitalPassword.ucp15')}}</div><!--请绑定持卡人本人的银行卡并确认卡号,避免后期提款无法到账 -->
          </div>
        </div>
        <button
          type="button"
          ...
          @click="mSave"
        >
          <span>{{$t('member.userCapitalPassword.ucp16')}}</span><!-- -->
        </button>
      </div>
    </div>
  </div>
...
.userCapitalPwd .el-form-item__label {
  color: #fff;
}
...
.userCapitalPwd .el-button--primary {
