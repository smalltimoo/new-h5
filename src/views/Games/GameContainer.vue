    ...
    <div class="game-container">
        <div class="game-body">
            <div class="game-center">
                ...
                <div class="move" id="move" ref="TopHeader" @click="panel=!panel"></div>

                <div class="window" v-if="panel">
                    <div class="close" @click="panel=false"></div>
                    <div class="top">
                        <Button type="error">转账</Button>
                    </div>
                    <div class="window-panel">
                        <span>
                            转账金额：
                            <input type="text" v-model="vm.dealCoin" placeholder="请输入金额" class="input"/> 元
                        </span>
                        <span style="color: #960000;font-size: 12px;margin: 10px 0">
                            中心钱包: {{this.cLoginUser.centerAmount/100}}元
                        </span>
                        <span class="moneys">
